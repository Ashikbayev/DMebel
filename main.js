...
function dogVariantChange() {
  ...
  var p2 = tot - p1 - p3;
  var td = $('dog-total-display'); if (td) td.textContent = fm(tot);
  var e1 = $('dog-pay1'); if (e1) e1.textContent = fm(p1);
  var e2 = $('dog-pay2'); if (e2) e2.textContent = fm(p2);
  var e3 = $('dog-pay3'); if (e3) e3.textContent = fm(p3);
}
...
function generateDogovor() {
  ...
  var advPct  = parseInt(($('dog-advance')||{}).value) || 50;
  var tot     = varV === 'P' ? C.BP.tot : (varV === 'K' ? C.BK.tot : C.BL.tot);
  var p1 = Math.round(tot * advPct / 100);
  var p3 = Math.round(tot * 0.10);
  var p2 = tot - p1 - p3;
  var today   = new Date();
  ...
  (C.ldspIt||[]).forEach(function(it) {
    corpRows += '<tr><td>\u041a\u043e\u0440\u043f\u0443\u0441 (\u041b\u0414\u0421\u041f)</td><td>' + it.n + '</td><td>' + it.q + ' \u043b.</td></tr>';
  });
  (C.fldspIt||[]).forEach(function(it) {
    corpRows += '<tr><td>\u0424\u0430\u0441\u0430\u0434 (\u041b\u0414\u0421\u041f)</td><td>' + it.n + '</td><td>' + it.q + ' \u043b.</td></tr>';
  });
  (C.fplenIt||[]).forEach(function(it) {
    corpRows += '<tr><td>\u0424\u0430\u0441\u0430\u0434 (\u041c\u0414\u0424 \u041f\u043b\u0451\u043d\u043a\u0430)</td><td>' + it.n + '</td><td>' + it.q + ' \u043b.</td></tr>';
  });
  (C.fkrIt||[]).forEach(function(it) {
    corpRows += '<tr><td>\u0424\u0430\u0441\u0430\u0434 (\u041c\u0414\u0424 \u041a\u0440\u0430\u0441\u043a\u0430)</td><td>' + it.n + '</td><td>' + it.q + ' \u043b.</td></tr>';
  });
  if (!corpRows) corpRows = '<tr><td>\u041a\u043e\u0440\u043f\u0443\u0441</td><td>&nbsp;</td><td>&nbsp;</td></tr><tr><td>\u0424\u0430\u0441\u0430\u0434</td><td>&nbsp;</td><td>&nbsp;</td></tr>';
  ...
  H += '<p class="c">\u0433. \u0421\u0430\u0442\u043f\u0430\u0435\u0432 &nbsp;&nbsp; ' + todayRU + '</p>';
  H += '<hr class="hr">';
  ...
  H += '<table><thead><tr><th style="width:32%">\u042d\u043b\u0435\u043c\u0435\u043d\u0442</th><th>\u041c\u0430\u0442\u0435\u0440\u0438\u0430\u043b / \u041f\u0440\u043e\u0438\u0437\u0432\u043e\u0434\u0438\u0442\u0435\u043b\u044c</th><th style="width:18%">\u0426\u0432\u0435\u0442 / \u041a\u043e\u043b.</th></tr></thead><tbody>' + corpRows + '</tbody></table>';
  H += '<p>1.4. \u0424\u0443\u0440\u043d\u0438\u0442\u0443\u0440\u0430:</p>';
  ...
  H += '<tr><td>\u041e\u0431\u0449\u0430\u044f \u0441\u0442\u043e\u0438\u043c\u043e\u0441\u0442\u044c \u0440\u0430\u0431\u043e\u0442 (\u0442\u0435\u043d\u0433\u0435)</td><td class="b">' + rub(tot) + '</td></tr>';
  ...
  H += '<div class="sw" style="margin-top:10pt"><div class="sc"><span class="sl">\u041f\u043e\u0434\u043f\u0438\u0441\u044c: __________ / \u041c\u0443\u0448\u0435\u043d\u043e\u0432 \u0422.\u0422.</span>';
...
function showKP(showL=true, showP=true, showK=false){
  ...
  function addRow(name, desc, qty, priceL, priceP, priceK) {
    ...
    var priceCols = "<td style=\"text-align:center;padding:14px 12px;font-size:14px;color:#C9A96E;border-bottom:1px solid #E8E3DA;vertical-align:top\">✓</td>";
    tableRows += "<tr>"
  ...
  kpHtml += "<li style=\"display:flex;gap:14px;padding:11px 0;border-bottom:1px solid #E8E3DA;font-size:13px;color:#3A3A3C;line-height:1.6;align-items:flex-start\"><span style=\"width:6px;height:6px;background:#C9A96E;border-radius:50%;flex-shrink:0;margin-top:7px\"></span><span>КП действительно 7 дней с даты выставления. Стоимость фиксируется при подписании договора.</span></li>";
