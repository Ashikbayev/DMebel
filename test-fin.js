  ...
  openFin('Продажи', function(){
    ...
    openFin('Аналитика', function(){
      ...
      openFin('Касса', function(){
        ...
        // 350 000 + процент мастеров 45 306 = 745 306, ничего не начислено.
        // Честный итог -443 266, а не +302 040.
        ok(net === -443266,
          'чистый доход месяца = \u2212443 266\u20B8 с учётом аренды, окладов И процента');
        ok(txt.indexOf('745 306') >= 0 || txt.indexOf('745306') >= 0,
          'на экране видно, что не начислено обязательств на 745 306\u20B8');
        ok(txt.indexOf('45 306') >= 0 || txt.indexOf('45306') >= 0,
          'процент и доп. работы (45 306\u20B8) названы в составе недостачи');
        ok(/\u0431\u0435\u0437 \u043d\u0430\u0437\u043d\u0430\u0447\u0435\u043d\u043d\u043e\u0433\u043e \u043c\u0430\u0441\u0442\u0435\u0440\u0430/.test(txt),
          'заказ без назначенного мастера отмечен отдельно — деньги учтены, получатель неясен');
