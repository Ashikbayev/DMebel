...
ok(h.indexOf('Стойка') >= 0 && h.indexOf('Крыша') >= 0 && h.indexOf('Дно') >= 0, 'детали названы по-русски в выносках');
ok(h.indexOf('[1] ') >= 0 && h.indexOf(' шт</text>') >= 0, 'выноски формата ПО: [поз] Имя / Ш×В×Т - N шт');
ok(h.indexOf('×16 - ') >= 0 && h.indexOf('×3 - ') >= 0, 'толщина в выносках: ЛДСП ×16, ХДФ ×3');
ok(h.indexOf(' мм</text>') >= 0, 'просветы ниш подписаны (как в ПО)');
